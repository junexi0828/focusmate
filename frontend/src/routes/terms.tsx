  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-slate-950 relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
        {/* Background Accents (Blue/Pink Blobs) */}
        ...
        >
          ...
          <Card className="p-8 md:p-12 bg-white/5 dark:bg-black/20 backdrop-blur-xl shadow-2xl border-white/10 dark:border-white/10">
            <div className="prose prose-invert max-w-none space-y-8">
              ...
              <section>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1 text-slate-400">
                  ...
                  <li>"회원"라 함은 회사의 서비스에 접속하여 본 약관에 따라 회사와 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 고객을 말합니다.</li>
                </ul>
              </section>
