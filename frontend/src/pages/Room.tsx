...
export function RoomPage({ onLeaveRoom }: RoomPageProps) {
  ...
  return (
    <div className="h-[calc(100vh-1rem)] m-2 rounded-2xl flex flex-col bg-slate-50/90 dark:bg-slate-950/90 backdrop-blur-3xl overflow-hidden transition-all duration-300">
      {/* Header */}
