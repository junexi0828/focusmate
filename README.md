...
- [핵심 기능](#-핵심-기능)
- [🤖 AI Testing Automation (자동화 테스팅)](#-ai-testing-automation-자동화-테스팅)
- [아키텍처 개요](#-아키텍처-개요)
- [기술 스택](#-기술-스택)
- [시작하기](#-시작하기)
  - [사전 요구사항](#사전-요구사항)
...
## 🤖 AI Testing Automation (자동화 테스팅)

본 프로젝트는 AI 기반 자동화 테스팅을 통해 시스템의 무결성과 품질을 지속적으로 검증합니다.

- **[AI Testing Automation Index](./docs/MASTER_EVALUATION_GUIDE.md)**: AI 기반 품질 검증을 위한 통합 인덱스.
